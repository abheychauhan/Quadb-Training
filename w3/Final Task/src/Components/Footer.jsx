...
export default function PortfolioScrollSection() {
  ...
  useEffect(() => {
    ...
    // Animate image upward inside the pinned container
    gsap.to(image, {
      y: "-200%", // adjust this based on how much scroll you want
      ease: "none",
      scrollTrigger: {
        trigger: container,
        start: "top top",
        end: "+=1000", // controls how long the scroll lasts
        scrub: true,
        pin: true,
      },
    });
